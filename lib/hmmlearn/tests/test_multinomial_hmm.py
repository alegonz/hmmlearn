...
class TestMultinomialAgainstWikipedia(object):
    ...
    def test_decode_viterbi(self, skip_parameter_checks):
    ...
    @pytest.mark.parametrize('skip_parameter_checks', [False, True])
    def test_decode_map(self, skip_parameter_checks):
        X = [[0], [1], [2]]
        self.h.skip_parameter_checks = skip_parameter_checks
    ...
    @pytest.mark.parametrize('skip_parameter_checks', [False, True])
    def test_predict(self, skip_parameter_checks):
        X = [[0], [1], [2]]
        self.h.skip_parameter_checks = skip_parameter_checks
...
class TestMultinomailHMM(object):
    ...
    @pytest.mark.parametrize('skip_parameter_checks', [False, True])
    def test_score_samples(self, skip_parameter_checks):
